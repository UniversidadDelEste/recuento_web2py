...
'Admin': 'Admin',
'admin': 'admin',
'admin disabled because no admin password': 'admin deshabilitadx por falta de contraseña',
'admin disabled because not supported on google app engine': 'admin deshabilitadx, no es soportado en GAE',
'admin disabled because unable to access password file': 'admin deshabilitadx, imposible acceder al archivo con la contraseña',
'Admin is disabled because insecure channel': 'Admin deshabilitadx, el canal no es seguro',
'Admin is disabled because unsecure channel': 'Admin deshabilitadx, el canal no es seguro',
'Administrative interface': 'Interfaz administrativa',
'Administrative Interface': 'Interfaz Administrativa',
'Administrator Password:': 'Contraseña de la Administradora:',
...
'and rename it:': ' y renómbrela:',
'appadmin': 'appadmin',
'appadmin is disabled because insecure channel': 'admin deshabilitadx, el canal no es seguro',
'application "%s" uninstalled': 'aplicación "%s" desinstalada',
'application compiled': 'aplicación compilada',
'application is compiled and cannot be designed': 'la aplicación está compilada y no puede ser modificada',
'Apply changes': 'Aplicar cambios',
'Appointment': 'Nombramiento',
'Are you sure you want to delete file "%s"?': '¿Seguro desea eliminar el archivo "%s"?',
'Are you sure you want to delete this object?': '¿Seguro desea borrar este objeto?',
'Are you sure you want to uninstall application "%s"': '¿Seguro desea desinstalar la aplicación "%s"',
'Are you sure you want to uninstall application "%s"?': '¿Seguro desea desinstalar la aplicación "%s"?',
'at': 'en',
...
'ATTENTION: you cannot edit the running application!': '¡ATENCIÓN: no puede modificar la aplicación que está ejecutándose!',
...
"Buy web2py's book": "Compra el libro web2py's ",
'Cache': 'Caché',
'cache': 'caché',
...
'Confirm Password': 'Confirm Password/ Confirme Contraseña',
'Consultas': 'Consultas',
'contains': 'contiene',
...
'Descripcion Grafico': 'Descripcion Grafico',
...
"Don't know what to do?": '¿No sabe qué hacer?',
'done!': '¡hecho!',
'Download': 'Descargas',
...
'First name': 'Nombre',
'Forgot username?': '¿Olvidó el nombre de usuaria?',
...
'Id Ubicacion Padre': 'Id Ubicacion Padre',
'Idx Fila': 'Idx Fila',
...
'loading...': 'cargando...',
'Log In': 'Log In/ Inicio de Sesión',
'Log Out': 'Log Out',
'Logged in': 'Sesión iniciada',
'Logged out': 'Sesión finalizada',
'Login': 'Inicio de sesión',
'login': 'inicio de sesión',
'Login disabled by administrator': 'Inicio de sesión deshabilitado por la persona administradora',
...
'Subir Telegrama': 'Subir Telegrama',
'Subir Telegrama 2': 'Subir Telegrama 2',
'Submit': 'Enviar',
'submit': 'enviar',
'Success!': '¡Correcto!',
'Support': 'Soporte',
'Sure you want to delete this object?': '¿Seguro desea eliminar este objeto?',
'table': 'table',
'Table': 'tabla',
...
'User %(id)s is impersonating %(other_id)s': 'Usuarix %(id)s está suplantando %(other_id)s',
'User %(id)s Logged-in': 'Usuarix %(id)s inició la sesión',
'User %(id)s Logged-out': 'Usuarix %(id)s finalizó la sesión',
'User %(id)s Password changed': 'Contraseña de la persona usuaria %(id)s cambiada',
'User %(id)s Password reset': 'Contraseña de usuarix %(id)s reiniciada',
'User %(id)s Profile updated': 'Actualizado el perfil de usuarix %(id)s',
'User %(id)s Registered': 'Usuarix %(id)s Registrado',
'User %(id)s Username retrieved': 'Se ha recuperado el nombre de usuarix de usuarix %(id)s',
'User %(username)s Logged-in': 'Usuarix %(username)s inició la sesión',
"User '%(username)s' Logged-in": "Usuarix '%(username)s' inició la sesión",
"User '%(username)s' Logged-out": "Usuarix '%(username)s' finalizó la sesión",
'User Id': 'Id de Usuario/a',
'User ID': 'ID de Usuario/a',
'User Logged-out': 'Usuarix finalizó la sesión',
'Username': 'Nombre de usuarix',
'Username retrieve': 'Recuperar nombre de usuarix',
...
'Welcome': 'Bienvenida',
'Welcome %s': 'Bienvenidx %s',
'Welcome to web2py': 'Bienvenida a web2py',
'Welcome to web2py!': '¡Bienvenida a web2py!',
...
'Your username is: %(username)s': 'Su nombre de usuarix es: %(username)s',
}
